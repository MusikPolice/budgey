...
public class OfxTest extends AbstractParser {
	...
	public void testScotia() throws IOException, OFXParseException {
		...
		final Double availableBalance = this.getAvailableBalance("importer/ofx/scotia.ofx");
		final List<Transaction> transactions = this.getTransactions("importer/ofx/scotia.ofx");
	...
	public void testTangerine() throws IOException, OFXParseException {
		...
		final Double availableBalance = this.getAvailableBalance("importer/ofx/tangerine.ofx");
		final List<Transaction> transactions = this.getTransactions("importer/ofx/tangerine.ofx");
		...
		Assert.assertThat(transactions.get(0).getOrder(), IsEqual.equalTo(0));
		Assert.assertThat(transactions.get(0).getTransactionDate(), IsEqual.equalTo(DateTime.parse("2015-03-02")));
		...
		Assert.assertThat(transactions.get(1).getOrder(), IsEqual.equalTo(0));
		Assert.assertThat(transactions.get(1).getTransactionDate(), IsEqual.equalTo(DateTime.parse("2015-03-03")));
		...
		Assert.assertThat(transactions.get(2).getTransactionDate(), IsEqual.equalTo(DateTime.parse("2015-03-06")));
		...
		Assert.assertThat(transactions.get(3).getTransactionDate(), IsEqual.equalTo(DateTime.parse("2015-03-06")));
	...
	public void testRoyal() throws IOException, OFXParseException {
		...
		final Double availableBalance = this.getAvailableBalance("importer/ofx/royal.ofx");
		final List<Transaction> transactions = this.getTransactions("importer/ofx/royal.ofx");
		...
		Assert.assertThat(transactions.get(0).getOrder(), IsEqual.equalTo(0));
		Assert.assertThat(transactions.get(0).getTransactionDate(), IsEqual.equalTo(DateTime.parse("2016-02-08")));
		...
		Assert.assertThat(transactions.get(1).getOrder(), IsEqual.equalTo(0));
		Assert.assertThat(transactions.get(1).getTransactionDate(), IsEqual.equalTo(DateTime.parse("2016-01-18")));
